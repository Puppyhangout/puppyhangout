...
export const ActiveCall = observer(() => {
    ...
    const handle_change = e =>
        active_calls_store.set_call_field(selected_call_index, e.target.name, e.target.value)
    ...
    return (
        <Card
            title='Active Call'
            style={{ backgroundColor: 'darkgray', borderRadius: '20px', height: '100%' }}
        >
            <h3>Caller info</h3>
            ...
            >
                ...
                <Button
                    style={{ height: '32px', backgroundColor: 'lightgray' }}
                    onClick={() => {
                        active_calls_store.set_map_open(!active_calls_store.map_open)
                    }}
                >
                    Show Map
                </Button>
            ...
            <div className='p-fluid p-formgrid p-grid'>
                <div className='p-field p-col-12 p-lg-6 p-md-6 p-sm-12'>
                    ...
                    <Dropdown
                        value={covid}
                        options={['Positive', 'Negative', 'Positive in the house', 'Unknown']}
                        onChange={e =>
                            active_calls_store.set_call_field(selected_call_index, 'covid', e.value)
                        }
                        placeholder='Choose one...'
                    />
                </div>
