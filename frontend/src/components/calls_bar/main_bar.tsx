        ...
        <div>
            <Button
                ...
                style={{
                    ...
                    borderColor:
                        active_calls_store.selected_call_index === i ? 'white' : 'darkgrey',
                    borderRadius: '20px',
                    height: '75px',
                    width: '200px'
                    // margin: '5px',
...
export const MainBarComponent = observer(() => {
    return (
        ...
        >
            ...
            >
                {active_calls_store.active_calls?.map((call, el_index) => (
                    <CallTab key={el_index} i={el_index} />
                ))}
            </div>
            <Button
