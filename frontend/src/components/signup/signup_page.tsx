...
import { axios_post } from "../../helpers/api_helpers";
    ...
    <div className="signup-root">
      <div className="signup-container">
        ...
        <TextField
          ...
          onChange={action(
            (e: any) => (store.signup.users[0].email = e.target.value)
          )}
        />
        ...
        <TextField
          ...
          onChange={action(
            (e: any) => (store.signup.users[0].first_name = e.target.value)
          )}
        />
        ...
        <TextField
          ...
          onChange={action(
            (e: any) => (store.signup.users[0].last_name = e.target.value)
          )}
        />
        ...
        <TextField
          ...
          onChange={action(
            (e: any) => (store.signup.users[0].password = e.target.value)
          )}
        />
        ...
        <TextField
          ...
          onChange={action(
            (e: any) =>
              (store.signup.users[0].user_info[0].user_description =
                e.target.value)
          )}
        />
        ...
        {String(store.signup.has_puppy) === "true" && (
          <TextField
            ...
            onChange={action(
              // @ts-ignore
              (e: any) =>
                (store.signup.users[0].puppies[0].name = e.target.value)
            )}
          />
        )}
        ...
        {String(store.signup.has_puppy) === "true" && (
          <TextField
            ...
            onChange={action(
              // @ts-ignore
              (e: any) =>
                (store.signup.users[0].puppies[0].breed = e.target.value)
            )}
          />
        )}
        ...
        {String(store.signup.has_puppy) === "true" && (
          <TextField
            ...
            onChange={action(
              // @ts-ignore
              (e: any) =>
                (store.signup.users[0].puppies[0].size = e.target.value)
            )}
          />
        )}
        ...
        >
          <img
            ...
            src={store.signup.users[0]?.user_info[0]?.photo_url || blank_photo}
            alt="click to add"
          />
        </Button>
        ...
        {isSuccessful ? (
          <>
            <LoadingButton
              ...
              onClick={async () => {
                setIsLoading(true);
                await axios_post(`/send_verification_email`, {
