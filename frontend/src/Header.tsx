            ...
            <div className='header'>
                ...
                <Link to='/login'>
                    <Button
                        color='primary'
                        variant='contained'
                        onClick={action(() => (login_store.show_page = true))}
                    >
                        Login
                    </Button>
                </Link>
                ...
                <Link to='/signup'>
                    <Button
                        color='primary'
                        variant='contained'
                        onClick={action(() => (signup_store.show_page = true))}
                    >
                        Signup
                    </Button>
                </Link>
                ...
                <Link to='/setting'>
                    <Button
                        color='primary'
                        variant='contained'
                        onClick={action(() => (setting_store.show_page = true))}
                    >
                        Setting
                    </Button>
                </Link>
                ...
                <Link to='/chats'>
                    <Button
                        color='primary'
                        variant='contained'
                        onClick={action(() => (Chats.show_page = true))}
                    >
                        Chat
                    </Button>
                </Link>
            ...
            <div className='footer'>
                ...
                <Link to='/contact'>
                    <Button
                        color='secondary'
                        variant='light'
                        onClick={action(() => (Contact.show_page = true))}
                    >
                        Contact
                    </Button>
                </Link>
                ...
                <Link to='/about'>
                    <Button
                        color='secondary'
                        variant='light'
                        onClick={action(() => (About.show_page = true))}
                    >
                        About
                    </Button>
                </Link>
